...
## <span id="prepare">准备工作</span>
    ...
    glob: "^7.0.3"
## <span id="webpack">修改webpack配置</span>
### <span id="catalog">项目目录</span>
    ├── README.md
    ├── build
    │   ├── build.js
    │   ├── check-versions.js
...
### <span id="utils">utils.js文件</span>
    ...
    /* 这里是添加的部分 ---------------------------- 结束 */
### <span id="base">webpack.base.conf.js 文件</span>
...
### <span id="dev">webpack.dev.conf.js 文件</span>
    var utils = require('./utils')
...
### <span id="prod">webpack.prod.conf.js 文件</span>
    var path = require('path')
    var utils = require('./utils')
    var webpack = require('webpack')
    var config = require('../config')
